We have a recapture process that stops only if we choose it.Inside there is a call to the function that reads the input given by the user.Inside this function
